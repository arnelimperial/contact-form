    <header>
		...
		<section class="hero hero-header">
		    <div class="hero-body">
			    <div class="container">
				    <h1 class="title coder">
						<a href="https://arnelimperial.bitbucket.io" class="has-text-black">Arnel Imperial<br>
						<span class="subtitle is-6 tagline">Coding & Web Development</span></a>
					</h1>
				</div>
			</div>
